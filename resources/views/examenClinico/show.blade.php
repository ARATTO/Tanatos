		...
		<div class="row">
			<div class="col-md-10 col-md-offset-1">
				<div class="panel panel-warning">
					...
					<div class="panel-heading"> Respuesta Examen Clinico No. {{ $exClinico->expediente->id }}</div>
					<div class="panel-body">
						@include('bones-flash::bones.flash')
						@include('layouts.partials.flash')						
                        

                        {!! Form::open(['route' => 'examenesClinicos.store', 'method' => 'POST', 'files' => true]) !!}
                            ...
                            <div class="input-group has-success form-inline">
                                ...
                                {!! form::textArea('resultadoclinico', null , ['class' => 'form-control ', 'maxlength'=>"250"]) !!}
                            </div>
                            <hr> 
